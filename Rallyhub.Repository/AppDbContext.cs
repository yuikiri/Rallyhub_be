    ...
    public class AppDbContext : DbContext
    {
        ...
        private SecurityOptions _securityOptions = new();
        ...
        // SecurityOptions pepper = _configuration.GetSection("SecurityOptions").Bind(SecurityOptions);
        ...
        public static Guid UserId7 = Guid.NewGuid();//owner
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>(builder =>
            {
                ...
                //         PasswordHash = BCrypt.Net.BCrypt.EnhancedHashPassword("string" + _securityOptions.Pepper, hashType: BCrypt.Net.HashType.SHA384),
                //         Role = "Customer",    
                //         FirstName = "Quản",  
                //         LastName = "Trị",    
